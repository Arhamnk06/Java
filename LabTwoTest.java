...
public class LabTwoTest { 
    ...
    @Test public void testEveryOtherMass() {
    ...
    @Test public void testCreateZigZag1() {
        // Explicit test cases
    ...
    @Test public void testReverseAscendingSubarrays1() {
        int[] a1 = {42, 99, 17, 0};
        int[] b1 = {99, 42, 17, 0};
    ...
    @Test public void testReverseAscendingSubarrays2() {
    ...
    @Test public void testReverseAscendingSubarrays3() {
    ...
    @Test public void testReverseAscendingSubarrays4() {
    ...
    @Test public void testReverseAscendingSubarraysMass() {
        // Pseudorandom fuzz tester
        Random rng = new Random(SEED);
        CRC32 check = new CRC32();
    ...
    @Test public void testPancakeScramble1() {
        assertEquals("", LabTwo.pancakeScramble(""));
    }

    @Test public void testPancakeScramble2() {
        assertEquals("alu", LabTwo.pancakeScramble("lua"));
    }

    @Test public void testPancakeScramble3() {
        assertEquals("heya", LabTwo.pancakeScramble("yeah"));
    }

    @Test public void testPancakeScramble4() {
        assertEquals("eoeawsm", LabTwo.pancakeScramble("awesome"));
    }
    
    @Test public void testPancakeScramble5() {
